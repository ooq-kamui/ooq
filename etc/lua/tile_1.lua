...
function Tile.is_clmb(p_tile)
	local ret = ar.in_(p_tile, Tile.mstr.clmb)
	return ret
end

function Tile.is_soil(p_tile)
	local ret = ar.in_(p_tile, Tile.mstr.soil)
	return ret
end

function Tile.is_airflw_u(p_tile)
	local ret = ar.in_(p_tile, Tile.mstr.airflw_u)
	return ret
end
...
function Tile.is_elv(p_tile, dir)
	...
	local ret = _.f
	local t_tile
	if dir == "u" then t_tile = Tile.mstr.elv_u end
...
function Tile.is_wood(p_tile)
	...
	ret = ar.in_(p_tile, Tile.mstr.wood)
...
function Tile.is_wood_burn(p_tile)
	...
	ret = ar.in_(p_tile, Tile.mstr.wood_burn)
	return ret
end
